...
for i in range(classes):
    path = os.path.join(cur_path, 'D:\\code_of_ml&dl&nl\\Drowsiness and Emotion Recog\\dataset\\Train', str(i))
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "DriveGuard"))
    ...
    def classifyFunction(self):
        model = load_model('D:\\code_of_ml&dl&nl\\Drowsiness and Emotion Recog\\Road_sign_reco_model.h5')
        print("Loaded model from disk")

        try:
            if self.file:
                test_image = Image.open(self.file)
                test_image = test_image.resize((30, 30))  # Resize the image to match the model's input size
            ...
            self.textEdit.setText("Error during classification.")
    ...
    def trainingFunction(self):
        ...
        model.save("Road_sign_reco_model.h5")
